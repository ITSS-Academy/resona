...
export class MusicGenresService {
  ...
  //     name: 'Rap',
  //     image:
  //       'https://media.gq.com/photos/671967aeb1f4bc05f5cdaeb8/16:9/w_2560%2Cc_limit/state%2520of%2520rap%25201.jpg',
  ...
  //     name: 'Pop-Ballad',
  //     image:
  //       'https://i1.sndcdn.com/artworks-000103194071-whlggp-t500x500.jpg',
  //     color: '#6e2d0c',
  //     gradient: 'linear-gradient(135deg, #8E5AF7 0%, #FF8A5C 100%)',
  //   },
  //   {
  //     id: '51',
  //     name: 'Ballad',
  //     image:
  //       'https://file.hstatic.net/200000433953/file/giai_dieu_nhe_nhang_va_du_duong_bb1f975776f04299999cd607f062eb8c.jpg',
  //     color: '#6e2d0c',
  //     gradient: 'linear-gradient(135deg, #F9E4B7 0%, #EACDA3 50%, #D6AE7B 100%)',
  //   },
  //   {
  //     id: '1',
  //     name: 'Pop',
