...
export const removeTrackFromQueue = createAction(
  '[Queue] Remove Track From Queue',
  props<{ userId: string; trackId: string }>()
);

export const removeTrackFromQueueSuccess = createAction(
  '[Queue] Remove Track From Queue Success',
  props<{ message: string }>()
);

export const removeTrackFromQueueFailure = createAction(
  '[Queue] Remove Track From Queue Failure',
  props<{ error: any }>()
);
...
export const addPlaylistToQueueSuccess = createAction(
  '[Queue] Add Playlist To Queue Success',
  props<{ queueList: QueueModel[] }>()
);

export const addPlaylistToQueueFailure = createAction(
  '[Queue] Add Playlist To Queue Failure',
  props<{ error: any }>()
);
